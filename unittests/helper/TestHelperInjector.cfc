...
<cffunction name="createBeanInjector" output="false" access="public" returntype="any">
	...
	<cfset bf.loadBeans(expandPath("/unittests/externaladapters/beaninjection/ColdSpring.xml")) />
...
<cffunction name="testPathInjection" access="public" returntype="void">  
	...
	<cfset injector.injectPath(target, "/unittests/helper/") />
...
<cffunction name="testIncludeInjection" access="public" returntype="void">  
	...
	<cfset injector.injectInclude(target, "/unittests/helper/IncludeHelper.cfm") />
...
<cffunction name="testComponentInjection" access="public" returntype="void">  
	...
	<cfset injector.injectComponent(target, "/unittests/helper/ComponentHelper.cfc") />
	...
	<cfset assertTrue(getMetadata(bean).name eq "unittests.externaladapters.beaninjection.Bean", "componentHelper.getBean() not right type!") />
	<cfset bean2 = target.componentHelper.getBean2() />
	<cfset assertTrue(isObject(bean2), "componentHelper.getBean2() not object") />
	<cfset assertTrue(getMetadata(bean2).name eq "unittests.externaladapters.beaninjection.Bean2", "componentHelper.getBean2() not right type!") />
</cffunction>
